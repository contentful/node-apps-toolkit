...
const PathValidator = runtypes.String
  .withConstraint(s => s.startsWith('/'), {name: 'CanonicalURI'})

export const CanonicalRequestValidator = runtypes.Record({
...
export const SecretValidator = runtypes.String.withConstraint(s => s.length > 16, {name: 'SecretLength'})
